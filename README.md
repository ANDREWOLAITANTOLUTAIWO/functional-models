...
$Y = \theta_o + \theta_1\mathrm{I} + \theta_2\mathrm{S} + \theta_3\mathrm{R} + \theta_4\mathrm{T} + \theta_5\mathrm{t} + \theta_6\mathrm{A} + \theta_7\mathrm{W} + \theta_8 \mathrm{d} + \theta_9\mathrm{h} + \theta_{10}t\mathrm{A} + \theta_{11}\mathrm{Wd} + \theta_{12}\mathrm{td} + \theta_{13}\mathrm{t}^2 + \theta_{14}\mathrm{A}^2 + \theta_{15}\mathrm{W}^2 + \theta_{16}\mathrm{Ad}^2$		                                (9)
...
Based on the above modeling and evaluation, functional models that can be used to predict volume of water consumed in dry and wet seasons in any urban poor households were developed. Parameters (that is, intercept and coefficients of the nine variables) were substituted into Equation (7) to give Equation (13) and Equation (14) respectively. Since third-degree cubic polynomial gave better accuracies, values of the parameters in dry and wet seasons were determined and substituted into the third-degree cubic polynomial model in Equation (10) to form Equation (15) and Equation (16) respectively, which are the functional models for predicting volume of water consumed in urban poor households in dry and wet seasons. 
